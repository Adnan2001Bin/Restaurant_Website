    ...
    <div className="w-full flex justify-center bg-white my-4">
      <div className=" w-96 shadow-2xl bg-gray-50 text-stone-900 p-2">
        ...
        <div className="card-body ">
          ...
          <h1 className="font-fontFooter1 text-xl font-medium mb-1 mt-1">{post.dishName}</h1>
          <div className="browser-css font-fontFooter1 text-base mb-4">{parse(post.dishDetails)}</div>
          <h1 className="font-fontFooter1 text-lg font-medium">${post.dishPrice}</h1>
